...
# Vì sao ngưỡng đó cũng bảo vệ đúng thứ bạn cần nhất lúc thị trường xấu
...
Giữ mức lỗ mỗi lệnh ở 1-2,5% giữ cho bạn luôn ở dưới ngưỡng đó - nơi bạn vẫn đủ tỉnh táo để nhìn nhận khách quan lần sai vừa rồi, thay vì bị cuốn vào một trong hai trạng thái cực đoan phía trên.

# Một tài khoản đã vượt ngưỡng đó trông như thế nào

Tôi từng theo dõi một tài khoản trải qua đúng kịch bản này. Đầu năm, tài khoản đó chịu một khoản lỗ gần 18% chỉ trong một vị thế duy nhất - một quyết định dồn tỷ trọng lớn vào một cổ phiếu vì tin rằng cơ hội quá tốt. Theo đúng phần toán học ở trên, tài khoản đó cần lãi khoảng 22% chỉ để hòa vốn.

Điều xảy ra sau đó không phải là một quyết định kiên nhẫn chờ hồi phục. Trong sáu tuần tiếp theo, tài khoản liên tục vào những vị thế có tỷ trọng lớn hơn bình thường, ở những cổ phiếu có độ rủi ro cao hơn hẳn khẩu vị trước đó - một nỗ lực gỡ lại nhanh khoản đã mất. Kết quả là thêm hai lần lỗ nữa, đưa tổng mức giảm của tài khoản lên gần 40%. Ở mức đó, số lãi cần thiết để hòa vốn đã vượt quá 67% - một con số gần như không thể đạt được trong một khung thời gian hợp lý bằng phương pháp đầu tư thông thường.

Không có gì trong câu chuyện này liên quan đến việc phân tích cổ phiếu sai. Nguyên nhân gốc rễ chỉ đơn giản là: khoản lỗ đầu tiên đã vượt quá ngưỡng mà hệ thống tâm lý còn có thể xử lý một cách khách quan, và mọi quyết định sau đó được đưa ra từ trạng thái đã mất cân bằng, không phải từ một quy trình tỉnh táo.

## Đây không phải bài viết cho người đặt mục tiêu lợi nhuận cao nhất trong một lệnh

Tôi cần nói rõ điều này: nếu mục tiêu của bạn là tối đa hóa lợi nhuận của từng lệnh riêng lẻ, quy tắc 1% có thể khiến bạn cảm thấy bị kìm hãm - và về mặt toán học ngắn hạn, điều đó đúng. Một vị thế tỷ trọng lớn hơn, nếu đúng, sẽ mang lại lãi lớn hơn nhiều.
...
## Bước đầu tiên: tính đúng khối lượng vào lệnh trước, không phải sau
...
Xác định mức giá cắt lỗ hợp lý cho ý tưởng đầu tư đó - dựa trên phân tích kỹ thuật hoặc điểm gãy luận điểm cơ bản, không phải một con số tùy tiện. Tính khoảng cách phần trăm từ giá vào lệnh đến mức cắt lỗ đó. Sau đó, dùng công thức đơn giản: khối lượng cổ phiếu tối đa = (1% vốn tài khoản) chia cho (khoảng cách phần trăm đến điểm cắt lỗ). Con số này, chứ không phải cảm giác "cơ hội này chắc chắn lắm", mới là thứ quyết định bạn nên mua bao nhiêu cổ phiếu.
